			...
			<main className="bg-slate-50 pb-16 sm:pb-24">
				...
				<section className="mx-auto mt-12 grid max-w-5xl gap-8 px-5 lg:grid-cols-[7fr_3fr] lg:gap-12">
					...
					<aside className="h-fit rounded-xl bg-amber-50 p-6">
						...
						{destination.id === "masjid-istiqlal" && (
							<div className="mt-6 border-t border-emerald-100 pt-6">
								<p className="text-xs font-semibold uppercase tracking-wide text-gray-500">
									Media Sosial Resmi
								</p>
								<a
									href="https://www.instagram.com/masjidistiqlal.official/?hl=id"
									target="_blank"
									rel="noreferrer"
									className="group mt-3 inline-flex items-center gap-3 rounded-full bg-white px-4 py-2 text-sm font-medium text-emerald-800 shadow-sm ring-1 ring-emerald-100 transition-all hover:bg-emerald-50 hover:ring-emerald-200"
								>
									<div className="flex size-8 items-center justify-center rounded-full bg-gradient-to-tr from-amber-400 to-emerald-600 text-white transition-transform group-hover:scale-110">
